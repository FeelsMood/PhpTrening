...
--
-- Host: localhost
-- Czas generowania: 17 Lis 2018, 19:58
...
USE `Admin`;
--
-- Baza danych: `Admin Panel`
--
CREATE DATABASE IF NOT EXISTS `Admin Panel` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `Admin Panel`;
...
INSERT INTO `admins` (`user_id`, `username`, `password`, `first_name`, `last_name`, `email`) VALUES
(1, 'admin', '123', '', '', '');
...
('root', '[{\"db\":\"Admin Panel\",\"table\":\"admins\"},{\"db\":\"Admin Panel\",\"table\":\"users\"}]');
...
('root', '2018-11-17 15:43:31', '{\"lang\":\"pl\",\"Console\\/Mode\":\"collapse\"}');
